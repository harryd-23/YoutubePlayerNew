...
import com.example.youtube.adapter.CommentAdapter;
...
import com.example.youtube.presenter.ContentVideoPresenter;
import com.example.youtube.presenteriplm.ContentVideoPresenterIplm;
import com.example.youtube.view.ContentVideoView;
...
import static com.example.youtube.utils.Utils.RFC3339ToDateString;
...
public class ContentVideoActivity extends BaseActivity implements ContentVideoView{
    ...
    private ArrayList<com.example.youtube.model.listvideomodel.Item> favouriteVideos = new ArrayList<>();
    private LinearLayoutManager commentLayoutManager;
    private com.example.youtube.model.listvideomodel.Item video;
    ...
    public void getExtraData() {
        video = (com.example.youtube.model.listvideomodel.Item) getIntent().getExtras().getParcelable("video");
